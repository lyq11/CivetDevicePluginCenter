...
func (_obj *DeviceAuthProcess) QueryCompanyDeviceCBindAll(offset int32, limit int32, result *[]CompanyDeivceBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) QueryCompanyDeviceCBindAllWithContext(tarsCtx context.Context, offset int32, limit int32, result *[]CompanyDeivceBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) QueryCompanyDeviceCBindAllOneWayWithContext(tarsCtx context.Context, offset int32, limit int32, result *[]CompanyDeivceBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) QueryProductCompanyBindAll(offset int32, limit int32, result *[]CompanyProductBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) QueryProductCompanyBindAllWithContext(tarsCtx context.Context, offset int32, limit int32, result *[]CompanyProductBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) QueryProductCompanyBindAllOneWayWithContext(tarsCtx context.Context, offset int32, limit int32, result *[]CompanyProductBind, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceAuthProcess) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "QueryCompanyDeviceCBindAll":
		...
		if _withContext == false {
			_imp := _val.(_impDeviceAuthProcess)
			_funRet_, err = _imp.QueryCompanyDeviceCBindAll(offset, limit, &result, &count, &res)
		} else {
			_imp := _val.(_impDeviceAuthProcessWithContext)
			_funRet_, err = _imp.QueryCompanyDeviceCBindAll(tarsCtx, offset, limit, &result, &count, &res)
		}
	...
	case "QueryProductCompanyBindAll":
		...
		if _withContext == false {
			_imp := _val.(_impDeviceAuthProcess)
			_funRet_, err = _imp.QueryProductCompanyBindAll(offset, limit, &result, &count, &res)
		} else {
			_imp := _val.(_impDeviceAuthProcessWithContext)
			_funRet_, err = _imp.QueryProductCompanyBindAll(tarsCtx, offset, limit, &result, &count, &res)
		}
