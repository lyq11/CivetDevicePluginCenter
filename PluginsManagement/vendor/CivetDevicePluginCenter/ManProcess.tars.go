...
func (_obj *ManProcess) QueryBindWithPluginID(offset int32, limit int32, PluginID int32, result *[]PluginBind, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ManProcess) QueryBindWithPluginIDWithContext(tarsCtx context.Context, offset int32, limit int32, PluginID int32, result *[]PluginBind, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ManProcess) QueryBindWithPluginIDOneWayWithContext(tarsCtx context.Context, offset int32, limit int32, PluginID int32, result *[]PluginBind, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *ManProcess) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "QueryBindWithProduct":
		...
		if _withContext == false {
			_imp := _val.(_impManProcess)
			_funRet_, err = _imp.QueryBindWithProduct(offset, limit, ProductID, &result, &res)
		} else {
			_imp := _val.(_impManProcessWithContext)
			_funRet_, err = _imp.QueryBindWithProduct(tarsCtx, offset, limit, ProductID, &result, &res)
		}
	...
	case "QueryBindWithPluginID":
		...
		if _withContext == false {
			_imp := _val.(_impManProcess)
			_funRet_, err = _imp.QueryBindWithPluginID(offset, limit, PluginID, &result, &res)
		} else {
			_imp := _val.(_impManProcessWithContext)
			_funRet_, err = _imp.QueryBindWithPluginID(tarsCtx, offset, limit, PluginID, &result, &res)
		}
