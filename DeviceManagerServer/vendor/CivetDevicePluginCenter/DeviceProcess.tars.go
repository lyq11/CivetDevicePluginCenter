...
func (_obj *DeviceProcess) QueryAllDevice(offset int32, limit int32, devicelist *[]Device, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceProcess) QueryAllDeviceWithContext(tarsCtx context.Context, offset int32, limit int32, devicelist *[]Device, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceProcess) QueryAllDeviceOneWayWithContext(tarsCtx context.Context, offset int32, limit int32, devicelist *[]Device, count *int32, res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DeviceProcess) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "QueryAllDevice":
		...
		if _withContext == false {
			_imp := _val.(_impDeviceProcess)
			_funRet_, err = _imp.QueryAllDevice(offset, limit, &devicelist, &count, &res)
		} else {
			_imp := _val.(_impDeviceProcessWithContext)
			_funRet_, err = _imp.QueryAllDevice(tarsCtx, offset, limit, &devicelist, &count, &res)
		}
